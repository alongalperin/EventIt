...
let mailSender = function(to, eventId, guestId) {
    ...
    if (guestId) { // this is mail for inviting guest
        ...
        html:  `<center>
                <h2 style="font-family: Roboto">Hi, you are invited to an event! All the details in link:</h2> <br/> 
    ...
    if (!guestId) {// this is mail for manage
        var mailOptions = {
            ...
            html:  `<center>
                    <h2 style="font-family: Roboto">Congratulations! You created an event</h2> <h3> here is a link for managing:</h3> 
